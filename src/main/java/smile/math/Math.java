...
public class Math {
     ...
     */
    public static double[][] pdist(double[][] x) throws java.lang.InterruptedException {
        int n = x.length;
     ...
     */
    public static void pdist(double[][] x, double[][] dist, boolean squared, boolean half) throws java.lang.InterruptedException {
        int n = x.length;
